                            ...
                            if (collected.first().content.toLowerCase() === 'dm') { // || collected.first().content.toLowerCase() === 'y'){
                                ...
                                let helpMenu = new Menu(message.channel, message.author.id, [{
                                    ...
                                    content: new MessageEmbed({
                                        ...
                                        description: `[Support Server](${config.discordinvite}) | [Invite URL](https://discord.com/oauth2/authorize?client_id=770365212704243784&scope=bot&permissions=101440)`,
                                        fields: [{
